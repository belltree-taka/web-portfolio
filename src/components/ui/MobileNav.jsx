...
const MobileNav = ({setIsMobileNavOpen, mobileNavClickHandler}) => {
    ...
    return (
        <div className={`text-sky-100 fixed overscroll-contain bg-sky-950/95 backdrop-blur-sm inset-0 z-10 flex flex-col justify-center items-center transition-all duration-300 ${isClosing ? "opacity-0 " : "opacity-100"}`}>
