...
const Hero = () => {
  ...
  return (
      <section className="w-screen min-h-dvh header-gradient-bg flex justify-center items-center relative">
        <div className="flex flex-col justify-center items-center -translate-y-6 fade-in">
          <svg className="w-20 md:w-32 mb-6" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 322.6 269.4">
