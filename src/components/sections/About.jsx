      ...
      <div className="relative mb-8">
        <div className="max-w-6xl mx-auto lg:relative">
          <picture className="w-full flex justify-end">
            ...
            />
            <img
              className="min-h-96 object-cover rounded-l-2xl lg:rounded-2xl w-2/3 lg:w-3/5"
              src={portraitMd}
              srcSet={`${portraitSm} 640w, ${portraitMd} 768w`}
              alt="Takaharu Suzuki Portrait Photo"
            />
          </picture>
          <div className="border-l-4 border-l-sky-400 ps-3 absolute left-4 top-1/2 md:left-12 lg:left-20 lg:top-1/8">
